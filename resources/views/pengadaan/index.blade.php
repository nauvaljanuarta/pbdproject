                        ...
                        <tbody>
                            @foreach ($pengadaans as $pengadaan)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('detail.pengadaan', $pengadaan->id_pengadaan) }}"
                                            class="btn rounded-pill btn-warning">Lihat</a>
                                        <a href="{{ route('pengadaan.edit', $pengadaan->id_pengadaan) }}"
                                            class="btn rounded-pill btn-info">Edit</a>
                                        <form action="{{ route('destroy.pengadaan', $pengadaan->id_pengadaan) }}"
                                            method="POST" style="display:inline;"
                                            onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengadaan ini?');">
                                            @csrf
                                            @method('DELETE')
